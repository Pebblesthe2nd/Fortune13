...
/obj/item/clothing/suit
	...
	allowed = null
	armor = list("melee" = 5, "bullet" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
...
/obj/item/clothing/suit/f13/battlecruiser //Do we have Star Craft here as well?!
	...
	armor = list("melee" = 20, "bullet" = 15, "laser" = 5, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 20, "acid" = 0)
...
/obj/item/clothing/suit/f13/sheriff
	...
	icon_state = "sheriff"
	item_state = "det_suit"
	armor = list("melee" = 25, "bullet" = 30, "laser" = 10, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
...
/obj/item/clothing/suit/toggle/labcoat/f13/khan/battlecoat
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 25, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/armor/f13/generaluniform
	...
	armor = list("melee" = 20, "bullet" = 10, "laser" = 10, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0) //change those values
...
/obj/item/clothing/suit/hooded/cloak/goliath
	...
	armor = list("melee" = 45, "bullet" = 25, "laser" = 20, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60)
...
/obj/item/clothing/suit/hooded/parka/medical
	...
	armor = list("melee" = 30, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60)
...
/obj/item/clothing/head/hooded/parkahood/medical
	...
	armor = list("melee" = 30, "bullet" = 0, "laser" = 10, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60)
	flags_inv = HIDEEARS|HIDEEYES|HIDEHAIR|HIDEFACIALHAIR
...
/obj/item/clothing/suit/hooded/parka/grey
	...
	desc = "A staunch, practical parka made out of a wind-breaking jacket, reinforced with metal plates."
	armor = list("melee" = 20, "bullet" = 0, "laser" = 10, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 60, "acid" = 60)
...
/obj/item/clothing/suit/hooded/cloak/drake //SS13 item, obviously
	...
	armor = list("melee" = 60, "bullet" = 40, "laser" = 50, "energy" = 40, "bomb" = 70, "bio" = 60, "rad" = 50, "fire" = 100, "acid" = 100)
...
/obj/item/clothing/head/hooded/cloakhood/drake
	...
	armor = list("melee" = 65, "bullet" = 50, "laser" = 50, "energy" = 40, "bomb" = 70, "bio" = 60, "rad" = 50, "fire" = 100, "acid" = 100)
...
/obj/item/clothing/suit/hooded/cloak/hhunter
	...
	armor = list("melee" = 45, "bullet" = 35, "laser" = 20, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/head/hooded/cloakhood/hhunter
	...
	armor = list("melee" = 60, "bullet" = 40, "laser" = 30, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
	heat_protection = HEAD
	resistance_flags = FIRE_PROOF | ACID_PROOF
