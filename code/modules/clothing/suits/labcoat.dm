...
/obj/item/clothing/suit/toggle/labcoat/depjacket/sec
	...
	armor = list("melee" = 20, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 45)
...
/obj/item/clothing/suit/toggle/labcoat/depjacket/eng
	...
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 20, "bio" = 20, "rad" = 60, "fire" = 50, "acid" = 25)
