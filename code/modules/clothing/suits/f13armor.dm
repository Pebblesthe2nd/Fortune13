...
/obj/item/clothing/suit/armor
	...
	armor = list("melee" = 25, "bullet" = 25, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 10)
...
/obj/item/clothing/suit/armor/f13/leather_jacket
	...
	armor = list("melee" = 25, "bullet" = 20, "laser" = 5, "energy" = 15, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/leather_jacket/combat
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 15, "energy" = 20, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25)
...
/obj/item/clothing/suit/armor/f13/leather_jacket/combat/coat
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 35, "energy" = 25, "bomb" = 45, "bio" = 30, "rad" = 5, "fire" = 50, "acid" = 35)
...
/obj/item/clothing/suit/armor/f13/leather_jacket/combat/riotpolice
	...
	armor = list("melee" = 70, "bullet" = 40, "laser" = 35, "energy" = 30, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 35)
...
/obj/item/clothing/suit/armor/f13/punk
	...
	armor = list("melee" = 30, "bullet" = 20, "laser" = 0, "energy" = 5, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	strip_delay = 30
...
/obj/item/clothing/suit/armor/f13/leatherarmor
	...
	armor = list("melee" = 40, "bullet" = 20, "laser" = 10, "energy" = 15, "bomb" = 32, "bio" = 0, "rad" = 10, "fire" = 30, "acid" = 35)
	strip_delay = 40
...
/obj/item/clothing/suit/armor/f13/leatherarmor/reinforced
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 20, "energy" = 20, "bomb" = 35, "bio" = 0, "rad" = 15, "fire" = 40, "acid" = 35)
...
/obj/item/clothing/suit/armor/f13/metalarmor
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 0)
	slowdown = 0.5
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/combat
	...
	armor = list("melee" = 50, "bullet" = 40, "laser" = 30, "energy" = 60, "bomb" = 25, "bio" = 60, "rad" = 60, "fire" = 60, "acid" = 0)
	strip_delay = 60
...
/obj/item/clothing/suit/armor/f13/combat/mk2
	...
	armor = list("melee" = 60, "bullet" = 50, "laser" = 40, "energy" = 40, "bomb" = 39, "bio" = 70, "rad" = 70, "fire" = 70, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/combat/swat
	...
	icon_state = "armoralt"
	item_state = "armoralt"
	armor = list("melee" = 35, "bullet" = 55, "laser" = 35, "energy" = 35, "bomb" = 55, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30)
...
/obj/item/clothing/suit/armor/f13/combatrusted
	...
	armor = list("melee" = 35, "bullet" = 20, "laser" = 15, "energy" = 38, "bomb" = 48, "bio" = 58, "rad" = 10, "fire" = 58, "acid" = 18)
...
/obj/item/clothing/suit/armor/f13/combat/environmental
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 20, "energy" = 45, "bomb" = 55, "bio" = 70, "rad" = 100, "fire" = 60, "acid" = 50)
	strip_delay = 60
...
/obj/item/clothing/suit/armor/f13/tribal
	...
	icon_state = "tribal"
	item_state = "tribal"
	armor = list("melee" = 35, "bullet" = 25, "laser" = 10, "energy" = 5, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/chitinarmor
	...
	armor = list("melee" = 55, "bullet" = 30, "laser" = 45, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100)
	flags_inv = HIDEJUMPSUIT
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
...
/obj/item/clothing/suit/armor/tesla //changed from armor/laserproof
	...
	armor = list("melee" = 40, "bullet" = 35, "laser" = 55, "energy" = 55, "bomb" = 35, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 100)
...
/obj/item/clothing/suit/armor/f13/battlecoat/vault/marshal
	...
	armor = list("melee" = 35, "bullet" = 25, "laser" = 15, "energy" = 25, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 40, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/battlecoat/vault/armoured
	...
	armor = list("melee" = 50, "bullet" = 45, "laser" = 30, "energy" = 40, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 30, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/brahmin_leather_duster
	...
	armor = list("melee" = 35, "bullet" = 20, "laser" = 45, "energy" = 35, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10)
...
/obj/item/clothing/suit/armor/f13/harpercoat
	...
	armor = list("melee" = 35, "bullet" = 30, "laser" = 10, "energy" = 40, "bomb" = 25, "bio" = 40, "rad" = 35, "fire" = 80, "acid" = 0)
...
/obj/item/clothing/suit/toggle/armor/f13/rangercustomdark
	...
	armor = list("melee" = 50, "bullet" = 45, "laser" = 25, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/donor/soldier
	...
	icon_state = "soldier"
	item_state = "soldier"
	armor = list("melee" = 20, "bullet" = 25, "energy" = 30, "bomb" = 16, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 30)
...
/obj/item/clothing/suit/toggle/armor/f13/cloakranger //Reskinned trail ranger gear
	...
	armor = list("melee" = 20, "bullet" = 30, "energy" = 15, "bomb" = 25, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 50) //Same armor as trail ranger gear
...
/obj/item/clothing/suit/armor/f13/harbingermantle
	...
	icon_state = "scloak"
	item_state = "scloak"
	armor = list("melee" = 30, "bullet" = 30, "laser" = 10, "energy" = 55, "bomb" = 45, "bio" = 45, "rad" = 45, "fire" = 45, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/cyberpunk
	...
	armor = list("melee" = 50, "bullet" = 25, "laser" = 15, "energy" = 20, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 30)
...
/obj/item/clothing/suit/armor/f13/doom
	...
	icon_state = "praetor"
	item_state = "g_suit"
	armor = list("melee" = 40, "bullet" = 35, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 50, "acid" = 30)
	resistance_flags = UNACIDABLE
	strip_delay = 10
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/scoutarmor
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 25, "energy" = 30, "bomb" = 55, "bio" = 65, "rad" = 10, "fire" = 20, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/reconarmor
	...
	armor = list("melee" = 45, "bullet" = 30, "laser" = 25, "energy" = 30, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20)
	icon = 'icons/fallout/clothing/suits.dmi'
...
/obj/item/clothing/suit/armor/f13/mutant/poncho
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 5, "energy" = 10, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 30, "acid" = 20)
...
/obj/item/clothing/suit/armor/f13/mutant/metal/reinforced
	...
	armor = list("melee" = 80, "bullet" = 60, "laser" = 45, "energy" = 40, "bomb" = 50, "bio" = 60, "rad" = 40, "fire" = 30, "acid" = 20)
